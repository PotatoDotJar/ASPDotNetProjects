...
-- SQRIBE/TABLE;6def4e
-- Adding 7 rows to dbo.cmsContentType
...
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsContentType] ([pk],[nodeId],[alias],[icon],[thumbnail],[description],[isContainer],[allowAtRoot]) VALUES (536,1055,N'textPage',N'icon-document',N'folder.png',NULL,0,0);
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsContentType] ([pk],[nodeId],[alias],[icon],[thumbnail],[description],[isContainer],[allowAtRoot]) VALUES (538,1059,N'sEO',N'icon-document',N'folder.png',NULL,0,0);
