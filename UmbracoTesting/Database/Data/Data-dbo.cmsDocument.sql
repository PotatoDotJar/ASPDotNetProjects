...
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsDocument] ([nodeId],[published],[documentUser],[versionId],[text],[releaseDate],[expireDate],[updateDate],[templateId],[newest]) VALUES (1063,1,0,'433344AD-7C2F-4B5D-B4F9-2AB91B589B2B',N'About Us',CONVERT(datetime,NULL,121),CONVERT(datetime,NULL,121),CONVERT(datetime,'2018-12-05 15:59:50.403',121),1054,1);
-- SQRIBE/INSERT;6def4e
...
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsDocument] ([nodeId],[published],[documentUser],[versionId],[text],[releaseDate],[expireDate],[updateDate],[templateId],[newest]) VALUES (1063,0,0,'7A1BA00D-45F0-44E0-A144-A52AD9F7DB0E',N'About Us',CONVERT(datetime,NULL,121),CONVERT(datetime,NULL,121),CONVERT(datetime,'2018-12-05 15:55:21.910',121),1054,0);
-- SQRIBE/INSERT;6def4e
...
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsDocument] ([nodeId],[published],[documentUser],[versionId],[text],[releaseDate],[expireDate],[updateDate],[templateId],[newest]) VALUES (1063,0,0,'1638A112-EB7D-4B5D-ADDC-CC810B6F41E2',N'About Us',CONVERT(datetime,NULL,121),CONVERT(datetime,NULL,121),CONVERT(datetime,'2018-12-05 15:55:26.773',121),1054,0);
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsDocument] ([nodeId],[published],[documentUser],[versionId],[text],[releaseDate],[expireDate],[updateDate],[templateId],[newest]) VALUES (1061,0,0,'B3BFFB46-AEF3-403A-A0E4-DB9470FA6CEB',N'Home',CONVERT(datetime,NULL,121),CONVERT(datetime,NULL,121),CONVERT(datetime,'2018-12-05 13:41:29.020',121),1051,0);
-- SQRIBE/INSERT;6def4e
...
-- SQRIBE/INSERT;6def4e
INSERT INTO [dbo].[cmsDocument] ([nodeId],[published],[documentUser],[versionId],[text],[releaseDate],[expireDate],[updateDate],[templateId],[newest]) VALUES (1061,1,0,'CDC478F7-6912-4537-BE30-FCB720E02FC6',N'Home',CONVERT(datetime,NULL,121),CONVERT(datetime,NULL,121),CONVERT(datetime,'2018-12-05 15:51:30.003',121),1051,1);
